...
1. Монгол үгийн алдаа шалгах толио [эндээс](https://github.com/bataak/dict-mn/raw/main/mn_MN.zip) (mn_MN.aff, mn_MN.dic) татаж авна.
1. Англи үгийн алдаа шалгах толийг [эндээс](https://github.com/LibreOffice/dictionaries/tree/master/en) (en_US.aff, en_US.dic) татаж авна.
1. `~/.emacs` буюу `~/.emacs.d/init.el` тохиргооны файлаа нээнэ.
1. Дараах кодыг оруулна: англи болон монгол үгийн алдааг зэрэг шалгахаар `~/Library/Spelling` (Linux бол `/usr/share/hunspell`) хавтаст mn_MN болон en_US толиудыг (*.dic, *.aff) хуулсан байгаа гэж ойлгоё. Тэгвэл `macOS` бол
...
`Flyspell` нь `Emacs` системээс тусдаа ажилладаг `Aspell` эсвэл `Hunspell` программ уруу текст илгээж шалгуулдаг. Текст ихсэх тусам удааширдаг. Харин [`Jinx`](https://github.com/minad/jinx) бол `libenchant` санг шууд `Emacs` системийн модуль байдлаар ашиглаж, зөвхөн дэлгэц дээр харагдаж буй хэсгийг шалгадаг тул маш хурдан ажилладаг.
